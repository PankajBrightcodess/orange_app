...
<!-- Mirrored from designing-world.com/suha-v2.5.0/checkout-credit-card.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 08 Sep 2021 12:08:48 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="checkout-wrapper-area py-3">
          ...
          <div class="credit-card-info-wrapper"><img class="d-block mb-4" src="img/bg-img/credit-card.png" alt="">
            <div class="pay-credit-card-form">
              <form action="https://designing-world.com/suha-v2.5.0/payment-success.html" method="">
                <div class="mb-3">
